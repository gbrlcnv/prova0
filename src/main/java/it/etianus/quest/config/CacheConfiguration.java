...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(it.etianus.quest.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(it.etianus.quest.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
